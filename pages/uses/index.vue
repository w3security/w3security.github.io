  ...
  <div class="max-w-7xl pb-10 border-r border-l border-dashed border-gray-700 mx-auto">
    ...
    <div data-aos="zoom-in" class="max-w-4xl mx-4 sm:mx-auto bg-gray-900 shadow rounded-md overflow-hidden sm:rounded-lg">
      <div class="px-4 py-5 flex flex-row justify-between border-b border-indigo-600 sm:px-6">
        <div class="w-full">
          <a href="https://codestats.net/users/w3security" target="_blank" rel="noreferrer">
            <dl>
              ...
              <dd class="mt-1 flex justify-between items-baseline md:flex lg:flex">
                ...
                <div
                  ...
                  <svg class="-ml-1 mr-0.5 flex-shrink-0 self-center h-5 w-5 text-green-400" fill="currentColor"
                    viewBox="0 0 20 20">
      ...
      <div>
        <dl>
          <div v-for="(item, index) in $store.state.uses.meta" :class="index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-900'"
...
export default {
  head() {
    return {
      title: 'uses -- W3security | Friendly Neighborhood Developer'
    }
  },
  data() {
    return {
