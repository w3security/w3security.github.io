...
const create = async (feed) => {
  const hostname = `https://w3security.github.io`;
  feed.options = {
    title: `Blog & Projects | Gyan Prakash W3security`,
...
export default {
  ...
  head: {
    title: 'W3security | Friendly Neighborhood Developer',
    htmlAttrs: {
      lang: 'en'
    },
    meta: [
      ...
      { name: 'title', content: 'Gyan Prakash W3security | Friendly Neighborhood Developer' },
      { name: 'author', content: 'Gyan Prakash W3security | mail@w3security.github.io' },
      { property: 'og:type', content: 'website' },
      { property: 'og:url', content: 'https://w3security.github.io' },
      { property: 'og:title', content: 'W3security | Friendly Neighborhood Developer' },
      {
        property: 'og:description',
        content: 'I blog tech, write a weekend newsletter called Software Shots and tinker with side projects every now n then.'
      },
      { property: 'og:image', content: 'https://cdn.w3security.github.io/logo_dark.png' },

      { property: 'twitter:card', content: 'https://cdn.w3security.github.io/logo_dark.png' },
      { property: 'twitter:url', content: 'https://w3security.github.io' },
      { property: 'twitter:title', content: 'W3security | Friendly Neighborhood Developer' },
      {
        property: 'twitter:description',
        content: 'I blog tech, write a weekend newsletter called Software Shots and tinker with side projects every now n then.'
      },
      { property: 'twitter:image', content: 'https://cdn.w3security.github.io/logo_dark.png' },
    ],
    link: [
    ...
    script: [
      ...
      // { 'data-domain': 'w3security.github.io', src: 'https://analytics.lookatx.dev/js/plausible.js', async: true, defer: true, }
    ]
  },
  ...
  sitemap: {
    hostname: 'https://w3security.github.io',
